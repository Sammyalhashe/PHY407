...
QickArray::QickArray(double *data, int n_dims, int* dimensions) {
#ifdef _DEBUG_
  cout << "entering QickArray(double *data, etc.)" << endl;
#endif
  ...
  is_initialized_ = _TRUE_;

#ifdef _DEBUG_
  cout << "exiting QickArray(double *data, etc.)" << endl;
#endif
}
