...
public:
  ...
  //constructor taking second-hand data (preferably from NumPy)
  //no checks are done, so you are on your own with this one...
  QickArray(double *data, int n_dims, int* dimensions); 
