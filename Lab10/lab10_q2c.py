...
figure(1)
title('Diffusion-limited aggregation run for some particles until the centre is reached')
...
grid = zeros((Lp-1,Lp-1),bool)

i=0 # counter to keep track of animation of moving particle
while grid[centre_point,centre_point] == False:
    #i+=1 
